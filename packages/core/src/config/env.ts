...
const envSchema = z.object({
  ...
  APP_PUBLIC_BASE_URL: z.string().url().optional().or(z.literal("")),
  NEXT_PUBLIC_PUBLIC_BASE_URL: z.string().url().optional().or(z.literal("")),
  ...
  ADMIN_API_TOKEN: z.string().min(12).optional().or(z.literal("")),
